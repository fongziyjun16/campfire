                ...
                <Col span={16}>
                    <Layout style={{height: "100vh"}}>
                        <Sider width={250} style={{backgroundColor: "#CDE2FF"}}>
                            <Space align="center" direction="vertical" style={{width: "100%", paddingTop: "50px"}}>
                                <Image
                                    src={avatarUrl} height={160} width={160} preview={false}
                                    ...
                                    style={{borderRadius: "50%", border: "2px #E4E4E4 solid"}}
                                />
                        ...
                        <Content style={{backgroundColor: "white", paddingLeft: "5px"}}>
                            <Space direction="vertical" style={{width: "100%"}}>
                                <Card title="Dive In" style={{marginTop: "50px"}}>
